                ...
                <ul className="flex flex-col w-full text-black">
                  ...
                  {integrationPlateSelectionState.bool && allowIntegrationTowerOne  && !(integrationRiserSelectionState.bool) && integrationTowerOneSelectionState.bool && (
                    <SelectFormatted
                      ...
                      changeStateFunction={changeIntegrationTowerOnePositionState}
                    />
                  )}

                  {/*  Select, Kits  */}
                  {integrationPlateSelectionState.bool && <SelectFormatted
                    displayName={"Kits"}
                    options={kitData}
                    defaultValue={0}
              ...
              <Suspense fallback={null}>
                ...
                {integrationPlateSelectionState.bool && 
                  <RendererIntegrationRiser
                    ...
                    options={integrationRiserData}
                    key={integrationRiserSelectionState.value}
                  /> 
                }

                {integrationPlateSelectionState.bool && integrationTowerOneSelectionState.bool && 
                  <RendererIntegrationTower 
                    selectionState={integrationTowerOneSelectionState}
                    options={integrationTowerOneData}
                    key={integrationTowerOneData.value}
                    position={integrationTowerOnePositionState}
                  />
                }

                {integrationPlateSelectionState.bool && <ModelKitsRenderer />}
