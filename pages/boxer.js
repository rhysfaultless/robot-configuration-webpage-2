...
import ModelRobotChassisBase from "/components/three-models/boxer/ChassisBase";
import ModelRobotChassisPanels from "/components/three-models/boxer/ChassisPanels";
import ModelRobotChassisWheels from "/components/three-models/boxer/ChassisWheels";
import ModelRobotChassisLights from "/components/three-models/boxer/ChassisLights";
import RendererIntegrationRiser from "/components/three-models/boxer/RendererIntegrationRiser";

// json data imports - robot platform specific
import dataFile from "/public/json/DataBoxer";
        ...
        <main className="w-2/3 fixed h-screen right-0">
          <div className="w-full h-full z-0">
            <Canvas id="divToPrint" gl={{ preserveDrawingBuffer: true }}>
              ...
              <PerspectiveCamera makeDefault fov={65} position={[800, -100, 800]} />
