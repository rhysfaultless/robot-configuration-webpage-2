...
export default function Model(props) {
  ...
  const { nodes, materials } = useGLTF('/models/attachments/attachment-bracket-riser-60.glb');
  return (
    <group ref={group} {...props} dispose={null} position={modelPosition} rotation={modelRotation} >
      <mesh
        castShadow
        receiveShadow
        geometry={nodes['attachment-bracket-riser-60'].geometry}
        material={nodes['attachment-bracket-riser-60'].material}
      >
...
useGLTF.preload('/models/attachments/attachment-bracket-riser-60.glb');
